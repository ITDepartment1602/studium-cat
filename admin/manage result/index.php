  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title">Manage Result</div>
    ...
    HAVING AVG(history.score) IS NOT NULL";
              ...
              while ($rows = mysqli_fetch_array($data)) {
                // Determine the color based on average score
                $averageScore = round($rows['average_score'], 2);
                $color = 'black'; // Default color
                if ($averageScore < 40) {
                  $color = 'red';
                } elseif ($averageScore >= 40 && $averageScore <= 70) {
                  $color = 'black';
                ...
                <tr>
                  ...
                  <td><?php echo $rows['history_count']; ?></td>
                  <td style="color: <?php echo $color; ?>;"><?php echo $averageScore . '%'; ?></td>
                  <td>
                    <a href="open_history.php?student_id=<?php echo $rows['login_id']; ?>" style="color: #1B4965">Open</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
