...
$ap_title   = 'Expired Subscriptions';
$ap_extra_head = '
...
<div class="ap-card">
  <div class="ap-card-header">
    <div class="ap-card-title">
      <div class="ap-card-title-icon"><i class="bi bi-calendar-x-fill"></i></div>
  ...
  <div style="padding:16px 20px; overflow-x:auto;">
    <table id="expiredTable" class="table table-bordered" style="width:100%;">
      <thead>
        <tr>
          <th>Student No.</th>
          <th>Full Name</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?= htmlspecialchars($rows['dateexpired']) ?></td>
...
<script>$(\'#expiredTable\').DataTable();</script>';
