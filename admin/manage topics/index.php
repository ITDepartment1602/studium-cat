          ...
          <div id="id01" class="modal">
            <form class="modal-content animate" action="action.php" method="post" enctype="multipart/form-data">
              ...
              <div class="container">
                ...
                <input type="text" class="form-control" id="c_name" placeholder="Enter Packege Name" name="title">

                <label><b>Description:</b></label>
                <input type="text" class="form-control" id="c_desc" placeholder="Enter Packege Description"
                  name="description">

                <label><b>Image:</b></label>
                <input type="file" class="form-control" id="c_img" placeholder="Enter Course Image" name="image">
          ...
          <div class="container">
            <div class="box-container">
              ...
              while ($row = mysqli_fetch_array($query)) {
                if ($row['name'] == "NARC NGN Qbanks") {
                  $btn = '<a href="#" class="btn" style="pointer-events: none; opacity: 0.5; user-select: none; cursor: not-allowed;">Soon</a>';
                } else {
                  $btn = '<a href="title.php?title=' . $row['title'] . '" class="btn">Open</a>
            <a href="#" class="btn1" onclick="confirmDelete(\'' . $row['name'] . '\', \'' . $row['id'] . '\')">Delete</a>';
                }
                ?>
                <div class="box">
                  <img src="<?php echo $row['image']; ?>" alt="" style="width: 260px; height: 300px;">
                  <h3><?php echo $row['name'] ?></h3>
                  <p><?php echo $row['description'] ?></p>
                  <div style="display: flex; justify-content: center; align-items: center; gap: 10px;"> <?php echo $btn ?>
                  </div>
