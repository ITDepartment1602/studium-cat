          ...
          <div id="id01" class="modal">
            <form class="modal-content animate" action="action.php" method="post" enctype="multipart/form-data">
              ...
              <div class="container">
                ...
                <input type="text" class="form-control" id="c_name" placeholder="Input Group Name" name="groupname">
          ...
          <div class="container">
            <div class="sales-details">
              ...
              while ($row = mysqli_fetch_array($query)) {
                // Check if the group name is "Admin"
                if ($row['groupname'] !== "Admin") {
                  ?>
                  <div class="box-container">
                    <div class="box">
                      <h3><?php echo htmlspecialchars($row['groupname']); ?></h3>
                      <a href="grouplist.php?groupname=<?php echo urlencode($row['groupname']); ?>" class="btn">Open</a>
