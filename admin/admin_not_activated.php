    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">Not Activated Subscriptions</span>
            </div>
        </nav>
        ...
        <div class="home-content">
            ...
            <div class="sales-boxes">
                <div class="recent-sales box">
                    <div class="title" style="margin-bottom: 20px;">Not Activated Subscriptions List</div>
            ...
            AND dateexpired IS NULL";
                            ...
                            while ($rows = mysqli_fetch_array($data)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rows['subMonth']; ?> Month/s</td>
