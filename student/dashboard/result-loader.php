...
$stmt->bind_param("ii", $examTaken, $id);
$stmt->execute();
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Dangrek&family=Kanit:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap"
        rel="stylesheet">
</head>

<body>
    <div id="pre-loader">
        <p class="mt-56 note">Loading Result.....</p>

    </div>

    <button id="start" onclick="startQuiz()" style="display: none;">Start</button>
