      ...
      <div class="main_containerab">
        <div class="contentab">
          ...
          <div class="content1ab">
            ...
            <form>
              <br>
              <b style="font-size: 20px; ">Question 85</b><br><br>
          ...
          <div class="footerab">
            ...
            ?>
            <form method="POST"
              action="../question/question86.php?topics1=<?= $_GET['eid'] ?>&topics2=<?= $_GET['topics2'] ?>&kilanlan=<?= $_GET['kilanlan'] ?>&id=<?= $_GET['id'] ?>&kilanlanhistory=<?= $_GET['kilanlanhistory'] ?>&cc=<?= $correctCount ?>&wc=<?= $wrongCount ?>&qnums=<?= $qnumsString ?>">
