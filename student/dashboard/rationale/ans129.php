      ...
      <div class="main_containerab">
        <div class="contentab">
          ...
          <div class="content1ab">
            ...
            <form>
              <br>
              <b style="font-size: 20px; ">Question 129</b><br><br>
          ...
          <div class="content2ab">
            <form>
              <br>
              <?= nl2br(string: $fetch['rationale'] ?? 'No rationale available') ?>
              ...
              <div class="container">
                <div class="box-container">
                  ...
                  <div class="box">
                    ...
                    <p><?php echo nl2br($fetch['narcan']) ?></p>
                  </div>
          ...
          <div class="footerab">
            ...
            ?>
            <form method="POST"
              action="../question/question130.php?topics1=<?= $_GET['eid'] ?>&topics2=<?= $_GET['topics2'] ?>&kilanlan=<?= $_GET['kilanlan'] ?>&id=<?= $_GET['id'] ?>&kilanlanhistory=<?= $_GET['kilanlanhistory'] ?>&cc=<?= $correctCount ?>&wc=<?= $wrongCount ?>&qnums=<?= $qnumsString ?>">
