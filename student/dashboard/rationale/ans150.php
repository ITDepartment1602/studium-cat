...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $totalTime = $_POST['totalTime'] ?? 0; // Get the time taken
  $user_id = $_GET['id'];
  ...
  if ($row = $result->fetch_assoc()) {
    ...
    if ($count == 0) {
      ...
      $questionNumber = 150; // KASUKASUAN
      $timestamp = date('Y-m-d H:i:s'); // Current date and time in PH timezone
      $stmt->bind_param("iissssisssiss", $qq, $isCorrect, $fetch['topics1'], $fetch['system'], $fetch['cnc'], $timeTaken, $user_id, $examTaken, $ans, $correctAns, $questionNumber, $totalTime, $timestamp);
      $stmt->execute();
  ...
  <div class="containerab">
    <div class="navbaraba">
      ...
      <div
        ...
        <div
          style="display: flex; flex-direction: column; justify-content: center; align-items: center; color: #B10000;">
          <div>
            <?= sprintf('%02d:%02d:%02d', floor($totalTime / 3600), floor(($totalTime % 3600) / 60), $totalTime % 60) ?>
          </div>
          Total Time
        </div>
      </div>
      ...
      <div class="main_containerab">
        <div class="contentab">
          ...
          <div class="content1ab">
            ...
            <form>
              <br>
              <b style="font-size: 20px; ">Question 150</b><br><br>
          ...
          <div class="footerab">
                                  ...
                                  <table class="table table-striped data-table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=115&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=116&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=117&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=118&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=119&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=120&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=121&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=122&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=123&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=124&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=125&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=126&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=127&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=128&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=129&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=130&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=131&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=132&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=133&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=134&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=135&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=136&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=137&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=138&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=139&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=140&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=141&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=142&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=143&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=144&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=145&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=146&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=147&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=148&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td style="text-align: start;">
                                          <a href="../rationale/questionpages.php?questionNumber=149&examTaken=<?= $examTaken ?>&userId=<?= $id ?>"
                                            class="" target="_blank">Complete</a>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>Question Number: 150</td>
                                        <td style="color: red;">Seen</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </ul>
            ...
            ?>
            <form method="POST"
              action="../result-loader.php?topics1=<?= $_GET['eid'] ?>&topics2=<?= $_GET['topics2'] ?>&kilanlan=<?= $_GET['kilanlan'] ?>&id=<?= $_GET['id'] ?>&kilanlanhistory=<?= $_GET['kilanlanhistory'] ?>&cc=<?= $correctCount ?>&wc=<?= $wrongCount ?>&qnums=<?= $qnumsString ?>"
              onsubmit="return confirmEndQuiz(this);">
              <button class="question button2">Finish</button>
            </form>

            <script>
              function confirmEndQuiz(form) {
                swal({
