...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        if ($count == 0) {
            ...
            $stmt = $con->prepare("UPDATE review SET isCorrect = ?, timeTaken = ? WHERE questionId = ? AND examTaken = ? AND studentId = ?");
            $stmt->bind_param("iisis", $isCorrect, $timeTaken, $qq, $examTaken, $user_id);
            $stmt->execute();
        }
    }
}
...
<head>
    ...
    <script src="https://kit.fontawesome.com/c3ab2650dc.js" crossorigin="anonymous"></script>

</head>

<body>
    <div>
        <div class="qn">Question: 1 out of 150</div>
        ...
        <div class="containerab">
            <div class="navbaraba">
                ...
                <!-- malupiton -->
                <i class="fa-solid fa-circle-stop" style="position: absolute; right: 45px; color: #B10000; "></i>&nbsp;
                <div style="font-size: 14px; padding-right: 9px; color: #B10000; ">
                ...
                <div class="main_containerab">
                    <div class="contentab">
                        <div class="content3ab">
                            <div class="sidebar-link">
                                ...
                                <a style="cursor: pointer;">
                                    <i class="fa fa-arrows-alt" onclick="openFullscreen();"
                                        title="Enter Fullscreen"></i>
                                </a>
                                <a class="sidebar-link" style="cursor: pointer;">
                                    <i class="fa fa-times-circle" onclick="closeFullscreen();"
                        ...
                        <div class="content1ab">
                            ...
                            <form>
                                <br>
                                <b style="font-size: 20px; ">Question 1</b><br><br>

                                <!-- KUESTION Choices UPDATED COPY STARTS HERE -->
                            ...
                            <form>
                                ...
                                <div class="container">
                                    <div class="box-container">
                                        ...
                                        <div class="box">
                                            <b style="color: #0B2557; font-size: 20px; ">NARC Additional
                                                notes:</b><br><br>
                                            <p><?= nl2br(str_replace('\n', "\n", $fetch['narcan'])) ?></p>
                        ...
                        <div class="footerab">
                            <div class="footerac">
                                ...
                                ?>
                                <form method="POST"
                                    action="../index.php?bundle_name=<?php echo $endd['bundle_name']; ?>"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle"
                                                    style="color: black;"><b>Question Pages</b></h5>
                            ...
                            <form method="POST"
                                action="../question/question2.php?topics1=<?= $_GET['eid'] ?>&topics2=<?= $_GET['topics2'] ?>&kilanlan=<?= $_GET['kilanlan'] ?>&id=<?= $_GET['id'] ?>&kilanlanhistory=<?= $_GET['kilanlanhistory'] ?>&cc=<?= $correctCount ?>&wc=<?= $wrongCount ?>&qnums=<?= $qnumsString ?>">
