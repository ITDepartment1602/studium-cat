...
&nbsp;
         ...
         <!--==================== Content Left ====================-->
                    <div class="content1ab">
                     ...
                     ?> 
<form action="question13.php?q=quiz&step=2&eid=<?php echo $row['topics1']; ?>&n=9&id=<?php echo $_GET['id'] ?>&qid=<?php echo $row['correctans']; ?>&kilanlan=<?php echo $row['topic'] ?>&qq=<?php echo $row['id'] ?>" method='POST' enctype="multipart/form-data">
                      <br>
...
<form method="POST" action="question13.php?id=<?php echo $_GET['id']; ?>&kilanlan=<?php echo $_GET['kilanlan']; ?>">
