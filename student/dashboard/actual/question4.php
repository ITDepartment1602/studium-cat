...
&nbsp;
         ...
         <!--==================== Content Left ====================-->
                    <div class="content1ab">
                     ...
                     ?>
<form action="question5.php?q=quiz&step=2&eid=<?php echo $row['topics1']; ?>&n=4&id=<?php echo $_GET['id'] ?>&qid=<?php echo $row['correctans']; ?>&kilanlan=<?php echo $row['topic'] ?>&qq=<?php echo $row['id'] ?>" method='POST' enctype="multipart/form-data">
                      <br>
...
<form method="POST" action="question5.php?id=<?php echo $_GET['id']; ?>&kilanlan=<?php echo $_GET['kilanlan']; ?>">
