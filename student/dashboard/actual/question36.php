    ...
    <?php include "../header.php";?>
         ...
         <!--==================== Content Left ====================-->
                    <div class="content1ab">
                     ...
                     ?> 
                     <form action="../rationale/ans36.php?q=quiz&step=2&eid=<?php echo $row['topics1']; ?>&n=36&id=<?php echo $_GET['id'] ?>&qid=<?php echo $row['correctans']; ?>&kilanlan=<?php echo $row['topic'] ?>" method='POST' enctype="multipart/form-data">
                      <br>
