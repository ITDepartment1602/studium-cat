...
<body>
          ...
          <li style="width: 100%; background-color: #62B6CB;">
            <table id="table" style="margin-top: 20px; width: 100%; background-color: #1B4965;">
              ...
              <tr>
                ...
                <td>
                  <a href="https://www.facebook.com/NCLEX.Amplified.Technical" target="_blank" id="myVideo"
                    class="nav-link">
  ...
  <main class="mt-5 pt-4">
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
          <div class="card-body">
            ...
            <p style="font-size: 12px"><i>Please <b>DON'T</b> tap or <b>click</b> the <b>BACK button</b> to prevent any
                errors.</i></p>
            <br>
            <?php
            include '../../config.php';
            ...
            <div class="container">
              <div class="box-container">
                <div class="box">
                  <br>
                  <table class="table table-striped title1" style="font-size:25px;font-weight:500; margin-top: -30px">

                  </table>
                  <h1 class="title" style="color:#0A2558; font-size: 20px; font-weight:500;">Points scored</h1>
                  </center>
                  <?php
                ...
                <div class="box">
                  ...
                  <div style="display: flex; justify-content: end; gap: 10px">
                    <a href="index.php?bundle_name=<?php echo $fetch['bundle_name']; ?>" class="btn"
                      style="background: #1B4965; color: white; ">Go to Dashboard</a>
    ...
    <div style="margin-right: 100px; max-width: 100%; overflow-x: auto;">
      <style>
