              ...
              <table id="table" style="margin-top: -20px; width: 100%;">
                ...
                <tr>
                  <td class="nav-link px-1">
                      ...
                      ?>
                  <td>
                      <a href="my note/index.php?id=<?php echo $fetch['id'] ?>" id="myVideo" class="nav-link">
                  ...
                  <div class="container">
                      <div class="box-container">
                          ...
                          <div class="box">
                              ...
                              <a class="btn" style="background: #3D52A0;" data-bs-toggle="modal" data-bs-target="#exampleModal">Open</a>
                              <a href="index.php" class="btn" style="background: #DC2222;"><i class="ri-arrow-right-up-line"></i>Back</a>
                          </div>
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Select Test Mode</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    <center><br>
                                    <a href="topic.php?kilanlan=<?php echo $row['title'] ?>" class="btn" style="background-color:#5598C6; color: white;">Study Mode</a>
                                    <button type="button" class="btn" style="background-color:#5598C6; color: white;">Exam Experience</button>
                                  </center><br><br>
                                  </div>
                                </div>
                                </div>
