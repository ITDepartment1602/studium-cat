            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form method="post" action="update_note_process.php?id=<?php echo $_GET['id'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="note" name="note_content"
                          rows="21"><?php echo $note['note']; ?></textarea>
                      </div>
                      <button type="submit" class="btn"
                        style="background-color:#1B4965; color: #FFF; float: right;">Update
                      </button>&nbsp;&nbsp;&nbsp;&nbsp;
                      <a href="../../note.php?id=<?php echo $_GET['id'] ?>" type="submit" class="btn btn-danger"
                        ...
                        foreach ($result as $row) {
                          ...
                          <li class="list-group-item mt-2">
                            <div class="btn-group float-right">
                              <a href="delete_note.php?id=<?php echo $noteID ?>&login_id=<?php echo $login_id ?>">
                                <button type="button" class="btn btn-sm btn-light" title="Show">
