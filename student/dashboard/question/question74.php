...
<body>
    ...
    <div class="qn">Question: 74 out of 150</div>
                    ...
                    <div class="content1ab">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <!-- COPY DIZ WAN -->
                                <form
                                    action="../rationale/ans74.php?q=quiz&step=2&eid=<?= $concept ?>&n=1&id=<?= $_GET['id'] ?>&qid=<?= $row['correctans'] ?>&topics1=<?= $_GET['topics1'] ?>&topics2=<?= $_GET['topics2'] ?>&qq=<?= $row['id'] ?>&kilanlan=<?= $row['system'] ?>&kilanlanhistory=<?= $_GET['kilanlan'] ?>&cc=<?= $_GET['cc'] ?>&wc=<?= $_GET['wc'] ?>&qnums=<?= $qnumsString ?>"
                                    method='POST'>
                                    <!-- idagdagto -->
                                    <input type="hidden" name="time_taken" id="time_taken" value="0">
                                    <!-- end idagdagto -->
                                    <br>
                                    <b>Question 74</b><br><br>
                                    <!-- baguhinto -->
                                    <?= $row['question'] ?><br><br>
