...
// Retrieve selected concept and topics from URL
...
// Extract system names from selected topics (format: id|system_name)
$systems = [];
            ...
            <div class="main_containerab">
                <div class="contentab">
                    ...
                    <div class="content1ab">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ?>
                            <!-- MAKE SURE TO COPY THIS PART STARTS HERE -->
                            <form
                                action="../rationale/ans1.php?q=quiz&step=2&eid=<?= $concept ?>&n=1&id=<?= $_GET['id'] ?>&qid=<?= $row['correctans'] ?>&topics1=<?= $_GET['topics1'] ?>&topics2=<?= $_GET['topics2'] ?>&qq=<?= $row['id'] ?>&kilanlan=<?= $row['system'] ?>&kilanlanhistory=<?= $_GET['kilanlan'] ?>"
                                method='POST'>
                    ...
                    <div class="footerab">
                        ...
                        <!--==================== COPY FORM AND RENAME THE QUESTION TO question2.php ====================-->
